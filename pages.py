# pages.py  -  Cartel v9.8
# شامل: LOGIN_HTML, DASHBOARD_HTML, get_public_page_html()

# لوگوی Cartel (به‌صورت base64 داخلی، بدون نیاز به هاست خارجی)
...
<div class="wrap">
  <div class="card">
    <div class="brand">
      ...
      <div><div class="brand-name">Cartel</div><div class="brand-sub">v9.8</div></div>
    </div>
    <h1>ورود به پنل</h1>
    ...
    <div class="hint">
      ...
      <span class="hint-val" onclick="document.getElementById('pw').value='CARTELKING';document.getElementById('pw').focus()">CARTELKING</span>
    </div>
    <form id="form">
      <div class="field">
...
<div class="mob-top">
  <div class="ml">
    ...
    <span class="mob-title">Cartel</span>
  </div>
  <div class="mob-right">
...
<aside class="sidebar" id="sb">
  ...
  <div class="logo">
    ...
    <div><div class="logo-name">Cartel</div><div class="logo-sub">v9.8</div></div>
  </div>
  <div class="nav-wrap">
...
<section class="pg on" id="pg-overview">
  ...
  <div class="dash-footer">
    <span class="df-text">Cartel v9.8 · Railway</span>
...
<section class="pg" id="pg-support">
  ...
  <div class="srv-panel">
    <div class="srv-hero">
      ...
      <div class="srv-hero-text">
        <div class="srv-hero-domain">پشتیبانی Cartel</div>
        <div class="srv-hero-sub"><span class="dot dg pulse"></span> راه‌های ارتباطی با تیم Cartel</div>
      </div>
    </div>
    <div class="srv-tiles">
    </div>
